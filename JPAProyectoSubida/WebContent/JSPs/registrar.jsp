...
<body style="background-color:powderblue;">
 <div class="container col-lg-3">
    <form action="/JPAProyecto/RegistroTelefono" style="padding: 30px;">
    
    <div class="form-group">
       <h1 style="color:black;font-family: verdana;text-align:center;border: 1px solid black;">Registrar telefonos</h1>
   </div>
